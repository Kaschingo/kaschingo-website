...
)  # (kaschingo/config/settings/base.py - 3 = kaschingo/)
APPS_DIR = ROOT_DIR.path("kaschingo")
...
DATABASES = {"default": env.db("DATABASE_URL", default="postgres:///kaschingo")}
...
MIGRATION_MODULES = {"sites": "kaschingo.contrib.sites.migrations"}
...
ADMINS = [("""Steffen Exler""", "steffen.exler@pm.me")]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "kaschingo.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "kaschingo.users.adapters.SocialAccountAdapter"
